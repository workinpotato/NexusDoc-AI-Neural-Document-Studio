  ...
  return (
    <div className="answer-card">
      ...
      <div className="flex min-h-[220px] flex-col items-center justify-center px-6 py-8 text-center">
        ...
        <h3 className="mt-4 text-base font-bold text-slate-100">Ready for Document Analysis</h3>
        ...
        <div className="mt-4 flex items-center gap-2 rounded-full border border-cyan-500/20 bg-cyan-950/40 px-3.5 py-1.5 text-[11px] font-medium text-cyan-300">
          <Sparkles size={13} />
